...
| Instrument | Ticker | Signal class | Weather var | Region (bounding box) | As-published source |
|---|---|---|---|---|---|
| OJ (baseline) | `OJ=F` | ColdGrip | `freeze_prob` | Florida citrus belt | `noaa-gfs-bdp-pds` |
| Corn | `ZC=F` | DroughtGrip | `spi_30d` | US Corn Belt `[-104,36,-80,48]` | `noaa-gfs-bdp-pds` |
| Nat Gas | `NG=F` | StormGrip | `hurricane_prob` | Gulf of Mexico | `noaa-gfs-bdp-pds` |
| Wheat | `ZW=F` | DroughtGrip | `spi_30d` | Great Plains wheat `[-104,32,-96,48]` | `noaa-gfs-bdp-pds` |
| ERCOT Power | `ERCOT_POWER` | HeatGrip | `cdd_3day` | Texas (ERCOT) | `noaa-gfs-bdp-pds` |
