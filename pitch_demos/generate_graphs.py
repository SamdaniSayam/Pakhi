...
def generate_latency_graph():
    ...
    ax.text(0, latency_values[0] + 5, '< 1 Minute', ha='center', va='bottom', fontsize=12, fontweight='bold', color='#2ca02c')
    ax.text(1, latency_values[1] + 5, '2.5 Hours\n(150 Minutes)', ha='center', va='bottom', fontsize=12, fontweight='bold', color='#d62728')
...
def generate_alpha_curve():
    ...
    ax.plot(dates, pakhi_cum, label='Pakhi Walk-Forward Backtest (Sharpe 1.62)', color='#1f77b4', linewidth=3)
    ax.plot(dates, benchmark_cum, label='Commodities Benchmark (Buy & Hold)', color='#7f7f7f', linewidth=2, linestyle='--')
