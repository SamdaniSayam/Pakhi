...
def generate_tam_sam_som():
    ...
    for i in range(3):
        ...
        ax.barh(y_positions[i], widths[i], height=0.9, left=-widths[i]/2, color=colors[i], align='center', edgecolor='white', linewidth=2)
        
        # Add the explanatory text inside the funnel block
        ax.text(0, y_positions[i], labels[i], ha='center', va='center', color='white', 
