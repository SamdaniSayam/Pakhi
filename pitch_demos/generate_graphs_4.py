...
def generate_business_model():
    ...
    for i, bar in enumerate(bars):
        ...
        ax.text(bar.get_x() + bar.get_width()/2, yval + 500, labels[i], ha='center', va='bottom', 
                fontsize=13, fontweight='bold', color='#333333',
                bbox=dict(facecolor='white', alpha=0.9, edgecolor=colors[i], boxstyle='round,pad=0.8', linewidth=2))
