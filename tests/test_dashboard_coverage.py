...
def test_dashboard_forecast_table_rich(monkeypatch, capsys):
    ...
    dash.display_forecast_table([
        {"date": "2023-01-01", "temp_high": 10, "temp_low": 5, "wind": 15, "precip_prob": 0.5, "description": "Rain"}
    ])
...
def test_dashboard_signal_status_rich(monkeypatch):
    ...
    dash.display_signal_status([
        {"instrument": "NG", "action": "LONG", "confidence": 0.8, "size": 1.0, "reasoning": "Cold"},
        {"instrument": "CL", "action": "SHORT", "confidence": 0.8, "size": 1.0, "reasoning": "Warm"},
        {"instrument": "ZC", "action": "FLAT", "confidence": 0.8, "size": 1.0, "reasoning": "Neutral"}
    ])
